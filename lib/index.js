...
module.exports = /** @class */ (function () {
    ...
    ChunksWebpackPlugin.prototype.hookCallback = function (compilation) {
        ...
        this.compilation.hooks.processAssets.tap({
            ...
            _this.publicPath = _this.getPublicPath();
            _this.outputPath = _this.getOutputPath();
            _this.entryNames = _this.getEntryNames();
            _this.entryNames
            ...
            if (_this.options.generateChunksManifest) {
                _this.createChunksManifestFile();
            }
        });
    };
    /**
