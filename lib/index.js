...
module.exports = /** @class */ (function () {
    ...
    ChunksWebpackPlugin.prototype.sortsChunksByType = function (files) {
        var _this = this;
        return {
            styles: files.filter(function (file) { return _this.isValidExtensionByType(file, 'css'); }),
            scripts: files.filter(function (file) { return _this.isValidExtensionByType(file, 'js'); })
        };
    };
    /**
