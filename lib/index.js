...
module.exports = /** @class */ (function () {
     ...
     */
    ChunksWebpackPlugin.prototype.processAssets = function () {
        var _this = this;
    ...
    ChunksWebpackPlugin.prototype.createChunksManifestFile = function () {
        ...
        this.compilation.emitAsset('chunks-manifest.json', new this.webpack.sources.RawSource(output, false));
    };
    /**
    ...
    ChunksWebpackPlugin.prototype.createHtmlChunksFiles = function (_a) {
        ...
        if (htmlTags.scripts.length) {
            this.compilation.emitAsset(this.options.filename.replace('[name]', entryName).replace('[type]', 'scripts'), new this.webpack.sources.RawSource(htmlTags.scripts, false));
        }
        if (htmlTags.styles.length) {
            this.compilation.emitAsset(this.options.filename.replace('[name]', entryName).replace('[type]', 'styles'), new this.webpack.sources.RawSource(htmlTags.styles, false));
        }
    };
    /**
     * Throw an error
